...
const Dashboard = () => {
  return (
    <LayoutApp>
      <div className="bg-transparent flex flex-col lg:flex-row w-full h-full border-y border-r border-black/10 border-r-black/10 rounded-none lg:rounded-r-lg p-0 mt-0">
